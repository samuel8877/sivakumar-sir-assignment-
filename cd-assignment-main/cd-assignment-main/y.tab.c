...
static const char *const yytname[] =
{
  ...
  "INTEGER", "KEYWORD", "';'", "'='", "'+'", "'*'", "$accept", "program",
...
{
       0,     3,     5,    11,    12,    13,     7,     3,     0,    13,
       3,     4,    14,     6,     6,     8,     9,    14,    14
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 5: /* stmt: KEYWORD IDENTIFIER ';'  */
#line 59 "simple.y"
        { insert((yyvsp[-1].sval)); }
#line 1166 "y.tab.c"
    break;
